...
describe('Service Tests', () => {
  describe('Voiture Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Voiture(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Voiture', async () => {
      ...
      it('should update a Voiture', async () => {
        const returnedFromService = Object.assign(
          {
            nom: 'BBBBBB'
          },
      ...
      it('should return a list of Voiture', async () => {
        const returnedFromService = Object.assign(
          {
            nom: 'BBBBBB'
          },
      ...
      it('should delete a Voiture', async () => {
